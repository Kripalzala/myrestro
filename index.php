...
<body>
    ...
    include "include/secondary-header.php"; 
    ?>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            <ul>
                                <li><i class="fa fa-calendar-o"></i>  <?php echo $row['blog_date']; ?></li>
                            </ul>
                            <h5><a href="blog-details.php?bid=<?php echo $row['blog_id']; ?>"><?php echo $row['blog_title']; ?></a></h5>
